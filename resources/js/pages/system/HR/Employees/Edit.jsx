    ...
    return (
        <DashboardLayout title="Edit Employee">
                ...
                <Box mb={24} style={{
                    ...
                    <Group justify="space-between" align="center" wrap="wrap" gap="md" style={{ position: 'relative', zIndex: 1 }}>
                        <Group gap={10}>
                            ...
                            <Stack gap={1}>
                                <Text fw={900} size="lg" c="white">Edit Employee</Text>
                                <Text size="xs" style={{ color: 'rgba(255,255,255,0.7)' }}>{employee.name} — {employee.employee_number}</Text>
                            </Stack>
                        </Group>
                        <Box
                            component={Link}
            ...
            <EmployeeForm
                ...
                submitUrl={`/system/hr/employees/${employee.id}`}
                method="put"
