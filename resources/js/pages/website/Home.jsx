...
export default function Home() {
    ...
    return (
        <WebsiteLayout>
                        ...
                        <Box style={{ minHeight: '92vh', display: 'flex', alignItems: 'center', position: 'relative', overflow: 'hidden' }}>
                            <motion.div
                                style={{ position: 'absolute', inset: 0, backgroundImage: `url(${[
                                    '/our_pictures/sh13.jpeg',
                                    '/our_pictures/sh20.jpeg',
                                    '/our_pictures/sh17.jpeg',
                                    '/our_pictures/sh12.jpeg',
                                ][i]})`, backgroundSize: 'cover', backgroundPosition: 'center' }}
                                initial={{ scale: 1.08 }}
                                animate={{ scale: 1 }}
                                transition={{ duration: 8, ease: 'linear' }}
                            />
                            <Box style={{ position: 'absolute', inset: 0, background: isDark
                                ? 'linear-gradient(105deg, rgba(10,22,40,0.92) 0%, rgba(10,22,40,0.70) 55%, rgba(10,22,40,0.40) 100%)'
                                : 'linear-gradient(105deg, rgba(252,248,246,0.94) 0%, rgba(252,233,233,0.72) 55%, rgba(255,255,255,0.25) 100%)' }} />
                            <motion.div
                                style={{ position: 'absolute', top: '20%', right: '15%', width: 400, height: 400, borderRadius: '50%', background: 'radial-gradient(circle, rgba(199,58,58,0.15) 0%, transparent 70%)', pointerEvents: 'none' }}
                                ...
                                <Group align="flex-start" gap={60} wrap="nowrap">
                                    <Stack gap="xl" style={{ flex: 1, minWidth: 0 }}>
                                        ...
                                        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.3 }}>
                                            <Title order={1} c={isDark ? 'white' : '#0A1628'} style={{ fontSize: 'clamp(2.4rem, 5vw, 4rem)', lineHeight: 1.1, fontWeight: 900, textShadow: isDark ? 'none' : '0 2px 12px rgba(255,255,255,0.55)' }}>
                                                {slide.title}{' '}
                                                <Text component="span" style={{ color: isDark ? '#ED8E8E' : '#A82828', WebkitTextFillColor: isDark ? '#ED8E8E' : '#A82828', textShadow: isDark ? '0 2px 16px rgba(0,0,0,0.4)' : '0 1px 6px rgba(255,255,255,0.6)' }} inherit>
                                                    {slide.highlight}
                                                </Text>
                                            </Title>
                                        </motion.div>
                                        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.6, delay: 0.5 }}>
                                            <Text c={isDark ? 'gray.3' : 'gray.8'} size="lg" lh={1.8} maw={580} style={{ textShadow: isDark ? 'none' : '0 1px 2px rgba(255,255,255,0.7)' }}>{slide.desc}</Text>
                                        </motion.div>
                                            ...
                                            <Group gap="sm" wrap="wrap">
                                                {slide.features.map((f, fi) => (
                                                    <motion.div key={f} initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.7 + fi * 0.1 }}>
                                                        <Box style={{ background: 'rgba(199,58,58,0.15)', border: '1px solid rgba(199,58,58,0.35)', borderRadius: 20, padding: '6px 16px', backdropFilter: 'blur(8px)' }}>
                                        ...
                                        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.9 }}>
                                            <Group gap="md">
                                                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.97 }}>
                                                    <Button component={Link} href="/contact" size="lg" radius="xl" color="brand.4" style={{ paddingInline: 36, boxShadow: '0 0 30px rgba(199,58,58,0.5)' }}>
                                                        {T.common.getQuote}
                                                    </Button>
                                                </motion.div>
                                                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.97 }}>
                                                    <Button component={Link} href="/services" size="lg" radius="xl" variant="outline" color={isDark ? 'white' : 'brand.6'} style={{ paddingInline: 36 }}>
                                    ...
                                    <Box visibleFrom="md" style={{ width: 260, flexShrink: 0 }}>
                                        <motion.div initial={{ opacity: 0, x: 40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, delay: 0.5 }}>
                                            <Paper style={{ ...(isDark ? glass.dark : glass.light), borderRadius: 20 }} p="xl">
                                                <Stack gap="lg">
                                                    ...
                                                    {stats.map((s, si) => (
                                                        <motion.div key={s.label} initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.6 + si * 0.1 }}>
                                                            <Group justify="space-between" style={{ padding: '8px 0', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
                                                                <Text c={isDark ? 'gray.4' : 'gray.7'} size="sm">{s.icon} {s.label}</Text>
                                                                <Text c={isDark ? 'white' : '#0A1628'} fw={900} size="lg">{s.value}</Text>
                                                            </Group>
                                                        </motion.div>
                                                    ))}
                                                    <Text c={isDark ? 'gray.6' : 'gray.6'} size="xs">Handeni, Tanzania</Text>
                                                </Stack>
                                            </Paper>
                                        </motion.div>
                                    </Box>
            ...
            {/* ── Stats Bar ── */}
            <Box style={{ background: 'linear-gradient(90deg, #0A1628 0%, #A82828 50%, #0A1628 100%)', position: 'relative', overflow: 'hidden' }} py="xl">
                <motion.div style={{ position: 'absolute', inset: 0, backgroundImage: 'radial-gradient(circle at 50% 50%, rgba(199,58,58,0.1) 0%, transparent 70%)' }}
                            ...
                            {stats.map((s) => (
                                <motion.div key={s.label} variants={fadeUp}>
                                    <Stack align="center" gap={6} py="md">
                                        ...
                                        <Text fw={900} style={{ fontSize: '2.2rem', lineHeight: 1, color: '#fff' }}>
                                            {s.value}
                                        </Text>
                    ...
                    <SimpleGrid cols={{ base: 1, md: 2 }} spacing={80} style={{ alignItems: 'center' }}>
                        ...
                        <ScrollReveal variants={fadeRight}>
                            <Box style={{ borderRadius: 24, overflow: 'hidden', position: 'relative', minHeight: 460 }}>
                                <img src="/our_pictures/sh3.jpeg" alt="SH Malik Scania at the Handeni depot at sunset" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
                                <motion.div style={{ position: 'absolute', bottom: 24, left: 24, right: 24 }} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.4 }}>
                                    <Box style={{ ...glass.dark, borderRadius: 16, padding: '18px 22px' }}>
                                        <Group gap="md">
                                            <Box style={{ width: 8, height: 8, borderRadius: '50%', background: '#C73A3A' }} />
                                            <Stack gap={2}>
            ...
            <Box py={100} style={{ background: 'linear-gradient(135deg, #0A1628 0%, #0E4FA0 50%, #0A3A7A 100%)', position: 'relative', overflow: 'hidden' }}>
                <MeshBackground colors={['#C73A3A', '#0A3A7A', '#ED8E8E']} />
                <Container size="xl">
                    <ScrollReveal>
                        <Stack align="center" gap="sm" mb={60}>
                            <Badge variant="light" size="lg" style={{ ...glass.white, color: '#ED8E8E' }}>{services.badge}</Badge>
                                        ...
                                        <Box style={{ ...glass.white, borderRadius: 20, overflow: 'hidden', height: '100%' }}>
                                            ...
                                            <Box p="xl">
                                                ...
                                                <Stack gap={8}>
                                                    {s.features.map(f => (
                                                        <Group key={f} gap={8}>
                                                            <Box style={{ width: 6, height: 6, borderRadius: '50%', background: '#ED8E8E', flexShrink: 0 }} />
            ...
            <Box py={100} style={{ background: 'linear-gradient(160deg, #050E1E 0%, #0A2A5E 55%, #0E4FA0 100%)', position: 'relative', overflow: 'hidden' }}>
                <MeshBackground colors={['#0E4FA0', '#C73A3A', '#0A3A7A']} />
                <Box style={{ position: 'absolute', inset: 0, backgroundImage: 'radial-gradient(rgba(199,58,58,0.07) 1px, transparent 1px)', backgroundSize: '36px 36px', pointerEvents: 'none' }} />
                <Container size="xl" style={{ position: 'relative', zIndex: 1 }}>
                    <ScrollReveal>
                        <Stack align="center" gap="sm" mb={20}>
                            <Badge variant="light" size="lg" style={{ ...glass.white, color: '#ED8E8E' }}>{routes.badge}</Badge>
                            <Title order={2} ta="center" c="white" style={{ fontSize: 'clamp(1.8rem, 3vw, 2.5rem)' }}>
                                {routes.title}{' '}
                                <Text component="span" style={{ color: '#ED8E8E', WebkitTextFillColor: '#ED8E8E' }} inherit>
                                    {routes.highlight}
                    ...
                    <ScrollReveal>
                        <Box style={{ display: 'flex', justifyContent: 'center', paddingBottom: 52 }}>
                            <motion.div
                                style={{ display: 'inline-flex', alignItems: 'center', gap: 10, background: 'rgba(199,58,58,0.15)', border: '1px solid rgba(199,58,58,0.4)', borderRadius: 40, padding: '10px 26px', backdropFilter: 'blur(14px)' }}
                                animate={{ boxShadow: ['0 0 0px rgba(199,58,58,0)', '0 0 32px rgba(199,58,58,0.35)', '0 0 0px rgba(199,58,58,0)'] }}
                                transition={{ duration: 2.8, repeat: Infinity }}
                            >
                                <motion.div style={{ width: 10, height: 10, borderRadius: '50%', background: '#C73A3A' }}
                                ...
                                <motion.div key={r.to} variants={fadeUp} style={{ height: '100%' }}>
                                    <HoverCard style={{ height: '100%' }}>
                                        <Box style={{ ...glass.white, borderRadius: 24, overflow: 'hidden', height: '100%', position: 'relative', display: 'flex', flexDirection: 'column' }}>
                                            <Box style={{ height: 3, background: 'linear-gradient(90deg, #A82828, #C73A3A, #ED8E8E)', flexShrink: 0 }} />
                                            <Box style={{ position: 'absolute', top: -50, right: -50, width: 180, height: 180, borderRadius: '50%', background: 'radial-gradient(circle, rgba(199,58,58,0.12) 0%, transparent 70%)', pointerEvents: 'none' }} />
                                            <Box style={{ padding: '26px 24px 24px', flex: 1, display: 'flex', flexDirection: 'column' }}>
                                                ...
                                                <Group gap="sm" mt="auto" pt={4}>
                                                    ...
                                                    <Box style={{ flex: 1, background: 'rgba(199,58,58,0.18)', border: '1px solid rgba(199,58,58,0.25)', borderRadius: 10, padding: '8px 10px' }}>
            ...
            <Box py={100} style={{ background: 'linear-gradient(160deg, #0A1628 0%, #0E4FA0 50%, #0A1628 100%)', position: 'relative', overflow: 'hidden' }}>
                <motion.div style={{ position: 'absolute', inset: 0, backgroundImage: 'radial-gradient(ellipse at 30% 50%, rgba(199,58,58,0.08) 0%, transparent 60%)' }}
                                ...
                                <motion.div key={step.n} variants={fadeUp}>
                                    <Stack gap="md" align="flex-start">
                                        <Group gap="md" align="center">
                                            <motion.div
                                                style={{ width: 60, height: 60, borderRadius: '50%', background: 'rgba(199,58,58,0.15)', border: '2px solid rgba(199,58,58,0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.6rem' }}
                                                whileHover={{ scale: 1.1, background: 'rgba(199,58,58,0.3)' }}
                                            >
                                                {step.icon}
                                            </motion.div>
                                            <Text fw={900} c="rgba(199,58,58,0.4)" style={{ fontSize: '2rem', lineHeight: 1 }}>{step.n}</Text>
                                        </Group>
            ...
            <Box py={100} style={{
                background: isDark
                    ? 'linear-gradient(135deg, #050E1E 0%, #0A1628 100%)'
                    : 'linear-gradient(135deg, #FFF5F0 0%, #FCE9E9 100%)',
                position: 'relative', overflow: 'hidden',
            }}>
                {isDark && <MeshBackground colors={['#0E4FA0', '#0A3A7A', '#C73A3A']} />}
                {!isDark && <Box style={{ position: 'absolute', top: -80, left: -80, width: 300, height: 300, borderRadius: '50%', background: 'radial-gradient(circle, rgba(199,58,58,0.08) 0%, transparent 70%)', pointerEvents: 'none' }} />}
                <Container size="xl" style={{ position: 'relative', zIndex: 1 }}>
                    <SimpleGrid cols={{ base: 1, md: 2 }} spacing={80} style={{ alignItems: 'center' }}>
                        <ScrollReveal variants={fadeLeft}>
                            <Stack gap="xl">
                                ...
                                <Group gap="md">
                                    <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.97 }}>
                                        <Button component={Link} href="/contact" size="lg" radius="xl" color="brand.5" style={{ paddingInline: 36, boxShadow: '0 8px 30px rgba(199,58,58,0.35)' }}>
                                            {T.common.freeQuote}
                                        </Button>
                                    </motion.div>
                                    <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.97 }}>
                                        ...
                                        <motion.div key={item.label} variants={fadeUp}>
                                            <HoverCard>
                                                <Group gap="lg" style={{ ...(isDark ? glass.white : glass.light), borderRadius: 16, padding: '18px 22px' }}>
                                                    <Box style={{ width: 48, height: 48, borderRadius: 12, background: 'linear-gradient(135deg, #A82828, #C73A3A)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.4rem', flexShrink: 0 }}>
                                                        {item.icon}
                                                    </Box>
                                                    <Stack gap={2}>
